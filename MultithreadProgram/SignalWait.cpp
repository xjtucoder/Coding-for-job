...
pthread_cond_t tasks_cond; //条件信号变量，处理两个线程间的条件关系，当task>5时，hello2处理，反之hello1处理，直到task减为0
...
void* say_hello2(void* args)
{
    ...
    while(1)
    {
        ...
        else if(!is_signaled)
        {
            ...
            is_signaled=true; //表明信号已经发送，退出此线程
        }
...
int main()
{
    ...
    pthread_attr_setdetachstate(&attr, PTHREAD_CREATE_JOINABLE); //设置需要的线程属性参数，此处表示可join连接，
    //join表示主程序可以等待线程结束再去做某事
